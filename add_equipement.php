...
if (isset($_POST['Envoyer'])) {
  ...
  $query = $pdo->prepare("INSERT INTO `equipement` (`nom_eq`, `user_id`) VALUES (?, ?)");
  $query->execute(array($_POST['nom'], $_POST['utilisateur']));
...
?> 
  ...
  <form  method="POST">
   <div class="input-group mb-3">
    ...
    <input type="text" class="form-control" placeholder="Nom equipement" aria-label="Equipement" name="nom">
  </div> 
  <div class="input-group mb-3">
    <span class="input-group-text">@</span>
